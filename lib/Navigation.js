...
var Navigation = Class.$extend({
  ...
  findNodeClosestToPosition: function(nodes, needle) {
      var distance = Infinity;
      var closestNode = null;
  ...
  findPath: function(startPosition, targetPosition, zone, group, obstacleFlag) {
    ...
    var paths = this.astar.search(allNodes, closestNode, farthestNode, obstacleFlag);
